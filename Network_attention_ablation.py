...
class UNet(torch.nn.Module):
    # Global self-attention ablation switch:
    #   use_attention=True  -> original architecture
    #   use_attention=False -> disable every UNetBlock attention branch
    def __init__(self,
        ...
        use_diffuse         = True,          # Use U-Net for diffusion.
        use_attention       = True,          # Global switch for self-attention ablation.
    ):
        super().__init__()
